...
import { getBlogList } from "@/common/supabase";
import { useState, useEffect, useMemo } from "react";
import { BlurFade, BlurFadeText } from "@/components";
import { LanguageText, LanguageBlurFadeText, useLanguage } from "@/language";
import {
    Search,
    ChevronLeft,
    ChevronRight,
...
type BlogInsightsItem = Record<string, string | number | boolean | string[] | null | undefined>;

export function BlogInsights() {
    const { lang } = useLanguage();

    const [posts, setPosts] = useState<BlogInsightsItem[]>([]);
    ...
    useEffect(() => {
        async function fetchBlogPosts() {
            ...
            setPosts((data as BlogInsightsItem[]) || []);
            setIsLoading(false);
        }
        fetchBlogPosts();
    }, []);
