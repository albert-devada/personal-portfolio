    ...
    return (
        ...
        >
            <div
                data-timeline-line
                className={cn(
                    "absolute bg-gray-300 dark:bg-gray-600",
                    ...
                    "group-data-[orientation=vertical]:w-0.5 md:group-data-[orientation=vertical]:w-0.50", 
                    ...
                    "group-data-[orientation=horizontal]:h-0.5 md:group-data-[orientation=horizontal]:h-0.50",
                )}
            />
